...
CREATE TABLE `categorysecond` (
  ...
  CONSTRAINT `FKnkcjwxp1pejusd4u6shy6vlow` FOREIGN KEY (`cid`) REFERENCES `category` (`cid`)
...
insert  into `orderitem`(`itemid`,`count`,`subtotal`,`pid`,`oid`,`uid`) values (101,1,83,68,NULL,9036),(102,1,299,60,NULL,9037),(103,1,358,51,NULL,9038),(104,1,299,58,NULL,9038);
...
) ENGINE=InnoDB AUTO_INCREMENT=9039 DEFAULT CHARSET=utf8;

/*Data for the table `orders` */

insert  into `orders`(`oid`,`total`,`ordertime`,`state`,`name`,`phone`,`addr`,`uid`,`datetime`) values (9036,83,NULL,1,NULL,NULL,NULL,16,'2017-01-16 17:19:34'),(9037,299,NULL,1,NULL,NULL,NULL,20,'2017-02-04 15:50:00'),(9038,657,NULL,1,NULL,NULL,NULL,20,'2017-02-04 20:18:45');
...
CREATE TABLE `product` (
  ...
  CONSTRAINT `FK16clcubmsmpml7q61ln0qblla` FOREIGN KEY (`csid`) REFERENCES `categorysecond` (`csid`),
...
insert  into `user`(`uid`,`username`,`password`,`name`,`email`,`phone`,`addr`,`state`,`code`) values (16,'12345','1111','ffff',NULL,'12334556677889','hhhhhhhhhh',1,NULL),(17,'ninnnnnn','1111','ddddd',NULL,'ddddd','dddd',0,'7e234a4c530947338139e7136b89422797741149953d44f398353774a39314fc'),(18,'zs','827ccb0eea8a706c4c34a16891f84e7b','zhangsan',NULL,'12333','222',0,'ea4b480d710e4478be45dad969a5f23824f8216eaa7449a883ccc3f42f0cffc5'),(19,'zsS','202cb962ac59075b964b07152d234b70','111',NULL,'1111','111',1,NULL),(20,'zp','202cb962ac59075b964b07152d234b70','zhan',NULL,'12333','111',1,NULL),(21,'zyy','827ccb0eea8a706c4c34a16891f84e7b','zhangs',NULL,'122222222','dddddddd',1,NULL);
